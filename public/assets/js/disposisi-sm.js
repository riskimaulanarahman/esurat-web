$(document).ready(function(){
    ...
    var store = new DevExpress.data.CustomStore({
        key: "id_disposisi",
        load: function() {
            return sendRequest(apiurl + "/disposisi-api?module=suratmasuk&nik="+nikuser);
        },
        insert: function(values) {
            return sendRequest(apiurl + "/disposisi-api/", "POST", values);
        },
        update: function(key, values) {
            return sendRequestdis(apiurl + "/disposisi-api/"+key, "PUT", values);
            // return $.post(apiurl + "/disposisi-api/"+key,{'module':'suratmasuk','data':values});
        },
        remove: function(key) {
    ...
    queSifatSurat = [{id:1,value:"biasa"},{id:2,value:"segera"},{id:3,value:"penting"}];
        ...
        var dataGrid = $("#grid-dsuratmasuk").dxDataGrid({     
            dataSource: store,
            ...
            columns: [
                ...
                { 
                    caption: "asal surat",
                    dataField: "suratmasuk.asal_surat",
                    width: 150,
                    editorOptions: {
                        disabled: true
                    },
                ...
                { 
                    caption: "perihal",
                    dataField: "suratmasuk.perihal_surat",
                    width: 150,
                    editorOptions: {
                        disabled: true
                    },
                ...
                { 
                    caption: "tgl surat",
                    dataField: "suratmasuk.tgl_surat",
                    width: 150,
                    editorOptions: {
                        disabled: true
                    },
                ...
                { 
                    ...
                    dataField: "suratmasuk.tgl_diterima",
                    width: 150,
                    editorOptions: {
                        disabled: true
                    },
                ...
                { 
                    caption: "sifat surat",
                    dataField: "suratmasuk.sifat_surat",
                    width: 150,
                    editorOptions: {
                        disabled: true
                    },

...
-- Dumping structure for table absensiguru.initial_sistem
...
-- Dumping data for table absensiguru.initial_sistem: ~1 rows (approximately)
...
-- Dumping structure for table absensiguru.list_output_file
...
-- Dumping data for table absensiguru.list_output_file: ~0 rows (approximately)
/*!40000 ALTER TABLE `list_output_file` DISABLE KEYS */;
/*!40000 ALTER TABLE `list_output_file` ENABLE KEYS */;


-- Dumping structure for table absensiguru.migrations
...
-- Dumping data for table absensiguru.migrations: ~1 rows (approximately)
...
-- Dumping structure for table absensiguru.penduduk
...
-- Dumping data for table absensiguru.penduduk: ~2 rows (approximately)
...
-- Dumping structure for table absensiguru.ref_agama
...
-- Dumping data for table absensiguru.ref_agama: 7 rows
...
-- Dumping structure for table absensiguru.ref_daftar_syarat_surat_pelayanan
...
-- Dumping data for table absensiguru.ref_daftar_syarat_surat_pelayanan: 45 rows
...
-- Dumping structure for table absensiguru.ref_gol_darah
...
-- Dumping data for table absensiguru.ref_gol_darah: 13 rows
...
-- Dumping structure for table absensiguru.ref_ijazah_tertinggi
...
-- Dumping data for table absensiguru.ref_ijazah_tertinggi: 7 rows
...
-- Dumping structure for table absensiguru.ref_jenis_pekerjaan
...
-- Dumping data for table absensiguru.ref_jenis_pekerjaan: 89 rows
...
-- Dumping structure for table absensiguru.ref_jenis_surat_pelayanan
...
-- Dumping data for table absensiguru.ref_jenis_surat_pelayanan: 8 rows
...
-- Dumping structure for table absensiguru.ref_status_kawin
...
-- Dumping data for table absensiguru.ref_status_kawin: 4 rows
...
-- Dumping structure for table absensiguru.sessions
...
-- Dumping data for table absensiguru.sessions: ~1 rows (approximately)
/*!40000 ALTER TABLE `sessions` DISABLE KEYS */;
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('IwI9ZvDGv7NQ0vAnj2fnjPaI6FrsyDZ2h3wjGM2T', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.106 Safari/537.36', '', 1625044787);
/*!40000 ALTER TABLE `sessions` ENABLE KEYS */;


-- Dumping structure for table absensiguru.surat_keluar
...
-- Dumping data for table absensiguru.surat_keluar: ~0 rows (approximately)
/*!40000 ALTER TABLE `surat_keluar` DISABLE KEYS */;
/*!40000 ALTER TABLE `surat_keluar` ENABLE KEYS */;


-- Dumping structure for table absensiguru.surat_masuk
...
-- Dumping data for table absensiguru.surat_masuk: ~0 rows (approximately)
/*!40000 ALTER TABLE `surat_masuk` DISABLE KEYS */;
/*!40000 ALTER TABLE `surat_masuk` ENABLE KEYS */;


-- Dumping structure for table absensiguru.surat_pelayanan
...
-- Dumping data for table absensiguru.surat_pelayanan: ~0 rows (approximately)
/*!40000 ALTER TABLE `surat_pelayanan` DISABLE KEYS */;
/*!40000 ALTER TABLE `surat_pelayanan` ENABLE KEYS */;


-- Dumping structure for table absensiguru.tbl_absensi
CREATE TABLE IF NOT EXISTS `tbl_absensi` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_tbl_absensi_users` (`nip`),
  CONSTRAINT `FK_tbl_absensi_users` FOREIGN KEY (`nip`) REFERENCES `users` (`nip`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table absensiguru.tbl_absensi: ~0 rows (approximately)
/*!40000 ALTER TABLE `tbl_absensi` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_absensi` ENABLE KEYS */;


-- Dumping structure for table absensiguru.tbl_kode
...
-- Dumping data for table absensiguru.tbl_kode: ~0 rows (approximately)
/*!40000 ALTER TABLE `tbl_kode` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_kode` ENABLE KEYS */;


-- Dumping structure for table absensiguru.users
...
-- Dumping data for table absensiguru.users: ~6 rows (approximately)
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `email`, `nip`, `nama_lengkap`, `jabatan`, `nomor_hp`, `password`, `role`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'admin@gmail.com', 0, 'admin', 'admin', '08000000', '$2y$10$JNAlHB0qfxIBSVVIT72qDO5rZ8gpIDuLKSsMmZLGupP3qu1zr5M0G', 'admin', NULL, '2021-04-18 21:31:24', '2021-06-30 03:32:14'),
	(2, 'guru1@gmail.com', 612, 'Abdul Basith', 'guru1', '081', '$2y$10$F3trIS5OFakPTpFW3sJpZu9KWJtxmEFo2jcp4152iYPnoaJyW1dT6', 'guru', NULL, '2021-04-18 21:31:32', '2021-06-30 08:28:17'),
	(3, 'riski@gmail.com', 613, 'Riski Maulana Rahman', 'kepala sekolah', '082252088585', '$2y$10$n2nxJvDKJdCOVL2GEZXOD.3tMG77ma6.4eGJJpsNT8KOQj3P4Z.f6', 'admin', NULL, '2021-04-18 21:31:55', '2021-06-30 08:20:35'),
	(4, 'guru2@gmail.com', 614, 'Depi Supidin', 'guru2', '0812321', '$2y$10$RbhqZ/SK2m3XmF3wh2uy0.AMqFMPWcrvRdpQBLYDg/8SdhwlghpXa', 'guru', NULL, '2021-06-30 03:34:05', '2021-06-30 03:34:43'),
	(5, 'guru3@gmail.com', 615, 'Sugeng Purnomo', 'guru3', '0812345', '$2y$10$BWJnnnlKHqVG20NkrVQtJOt5r09VS5/4zQgkhirjxvvlOsOQcW8f2', 'guru', NULL, '2021-06-30 03:35:32', '2021-06-30 03:35:32'),
	(6, 'guru4@gmail.com', 616, 'Santiani', 'guru4', '0812345', '$2y$10$qrzAeQpehjctNWFtM/Ih2uUGdYDWw2MsQdbKD/Ewiqc4D4i0si7LC', 'guru', NULL, '2021-06-30 03:35:52', '2021-06-30 03:35:52');

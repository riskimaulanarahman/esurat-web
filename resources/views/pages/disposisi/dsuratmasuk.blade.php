	...
	<div class="col-xl-12">
		...
		<div class="panel panel-inverse">
			...
			<div class="panel-heading">
				<h4 class="panel-title">My Disposisi Surat Masuk</h4>
			...
			<div class="panel-body">
			    <div id="grid-dsuratmasuk" style="height: 640px; width:100%;"></div>
			</div>
			<!-- end panel-body -->
		</div>
		<!-- end panel -->
...
<script src="/assets/js/disposisi-sm.js?n=<?php echo rand(); ?>"></script>
